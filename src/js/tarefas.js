...
function create(){ //Função de criar um novo projeto
    ...
    novoProjeto.innerHTML = `<h1>${nomeProj.value}</h1>`; //Insere o Titulo que terá o nome do projeto
...
btnNovaAtividade.addEventListener("click", () => {
    ...
    inputResponsavel.placeholder = "Nome do responsável";
    inputResponsavel.style.display = "block";
    inputResponsavel.style.marginBottom = "5px";
    ...
    botaoSalvar.addEventListener("click", () => {
        ...
        if(inputNome.value.trim() == "" || inputDesc.value.trim() == ""){
            alert("A atividade deve ter um nome e uma descrição");
            return;
        } else {
            ...
            respAtividade.textContent = `Responsável: ${inputResponsavel.value}`;
            ...
            novaAtividade.style.backgroundColor = inputCor.value;
            ...
            editarAtividade.addEventListener("click", () => {
                ...
                const ResponsavelEditar = document.createElement("input");
                ...
                botaoSalvarEditar.addEventListener("click", () => {
                    ...
                    // Aqui tem um erro: atribui string diretamente a elemento
                    // Correção seria: respAtividade.textContent = `Responsável: ${ResponsavelEditar.value}` etc.
                    novaAtividade.style.backgroundColor = inputCorEditar.value;
    ...
    formAtividade.appendChild(inputResponsavel);
